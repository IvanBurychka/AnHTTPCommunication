...
var DataService = (function () {
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("api/books/" + id)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* map */])(function (b) { return ({
            bookTitle: b.title,
            year: b.publicationYear
        }); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* tap */])(function (classicBook) { console.log(classicBook); }));
    };
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getAllBooks().subscribe(function (data) { _this.allBooks = data; }, function (err) { console.log(err); }, function () { console.log('All done getting books.'); });
